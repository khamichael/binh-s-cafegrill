...
\chead{GENAFLEVERING Delrapport 1}
...
\includegraphics[scale=.5]{OOSE210.jpg} \\{\footnotesize Diagram 2.10}

\subsection{OOSE 5.3}
\includegraphics[scale=.5]{OOSE53.jpg} \\{\footnotesize Sekvensdiagram 5.3}
